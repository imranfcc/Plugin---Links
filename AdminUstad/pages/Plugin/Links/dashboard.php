...
<div class="modal" id="sh-Modal-Waiting"><div class="modal-dialog modal-dialog-centered text-center text-success"><i class="fas fa-cog fa-spin fa-5x mx-auto"></i></div></div>
